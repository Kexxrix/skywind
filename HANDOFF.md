...
GitHub 실행 소스 `73b165c320343af21b102befb5de0df8d7c9714e` 게시 후 **2026-09-08 02:34 KST에 공개 버전5 배포를 완료**했다. 공개 실행 파일101개 일치를 확인했다. 아래72개 지문/78개 테스트는 이전 PATCH2 기준본의 역사적 기록이다.
...
최신 공개본은 **2026-09-08 02:34 KST의 버전5**로, 승인된 파일럿 HUD FX3와 SV-01 21단계 뱅크·자체 회전 ±6°·192px WebP를 포함한다. [파일럿 공개 배포 기록](docs/PUBLIC_UPDATE_PILOT_20260908.md)을 먼저 확인한다. GitHub에도 동일 실행 소스를 게시했다. 아래 버전3 설명과 [SV-01 버전4 기록](docs/PUBLIC_UPDATE_SV01_20260907.md)은 이전 배포 이력이다.
